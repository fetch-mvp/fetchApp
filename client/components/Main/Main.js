  ...
  render(){
    ...
    return (
      <View style={{height: '100%'}}>
        ...
        <Content getAllMatches={this.props.getAllMatches} refreshQueue={this.refreshQueue} matches = {this.props.matches} queue = {this.state.queue} interestedDog = {this.state.interestedDog} changeInterestedDog = {this.changeInterestedDog} changeRoute = {this.changeRoute} route={this.state.route} user={this.props.user}/>
      </View>
    );
  }
}
